...
def general_ledger__get_new_ws(self, _p, _xs, data, objects, wb,
                               sheet_number=1):
...
def general_ledger_generate_xls_report(self, _p, _xs, data, objects, wb):
    ...
    for account in objects:
        ...
        display_ledger_lines = _p['_has_ledger_lines'](account)
        ...
        if _p.display_account_raw(data) == 'all' or \
            ...
            for line in _p['_get_ledger_lines_data'](account):
